...
from .utils import weight_init, gen_conv1,gen_deconv1_origin, gen_deconv1, gen_conv2 , gen_deconv2_origin, gen_deconv2, dis_conv
from .utils_origin import gen_conv, gen_deconv, dis_conv
class InpaintGeneratorLarge(nn.Module):
    def __init__(self, cnum=48):
        super(InpaintGeneratorLarge, self).__init__()
        self.cnum = cnum
        # stage1
...
class InpaintGeneratorHighRes(nn.Module):
    def __init__(self, cnum=48):
        super(InpaintGeneratorHighRes, self).__init__()
        self.cnum = cnum
        # stage1
